"""test_baseline.py - Test BASELINE (H_raw)"""
import sys
...
for img in tqdm(images, desc="Extracting"):
    ...
    features_list.append(feats['baseline_holonomy'])
...
np.savez(OUTPUT_DIR / "baseline_result.npz", auc=auc, features=features, labels=labels)
