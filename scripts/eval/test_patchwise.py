"""test_patchwise.py - Test PATCHWISE (H_raw)"""
import sys
...
for img in tqdm(images, desc="Extracting"):
    ...
    features_list.append(feats['patchwise_holonomy'])
...
print(f"✅ Patchwise AUC: {auc:.4f}")
np.savez(OUTPUT_DIR / "patchwise_result.npz", auc=auc, features=features, labels=labels)
