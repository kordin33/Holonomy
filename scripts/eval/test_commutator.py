"""test_commutator.py - Test COMMUTATOR (deterministic)"""
import sys
...
print("🔬 TEST: Commutator (deterministic)")
...
for img in tqdm(images, desc="Extracting"):
    ...
    features_list.append(feats['commutator'])
...
print(f"✅ Commutator AUC: {auc:.4f}")
np.savez(OUTPUT_DIR / "commutator_result.npz", auc=auc, features=features, labels=labels)
