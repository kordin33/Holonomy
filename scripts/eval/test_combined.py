"""test_combined.py - Test COMBINED (all features)"""
import sys
...
for img in tqdm(images, desc="Extracting"):
    ...
    features_list.append(feats['combined'])
...
np.savez(OUTPUT_DIR / "combined_result.npz", auc=auc, features=features, labels=labels)
