"""
test_v20_quick.py - Check if Patching H2 boosts V18 Core.
Sample: 100 images.
"""
...
from deepfake_guard.features.holonomy_v20 import HolonomyV20
...
def main():
    ...
    for img in tqdm(images):
        feats.append(v20.extract_features(encoder, img))
